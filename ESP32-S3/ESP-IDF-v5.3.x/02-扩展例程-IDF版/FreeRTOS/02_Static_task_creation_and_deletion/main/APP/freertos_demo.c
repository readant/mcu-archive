 ...
 */
 ...
 void freertos_demo(void)
 {
     ...
     spilcd_show_string(10, 47, 220, 24, 24, "Task Create & Del", RED);
     spilcd_show_string(10, 76, 220, 16, 16, "ATOM@ALIENTEK", RED);

     
     /* 创建任务1 */
     Task1Task_Handler = xTaskCreateStaticPinnedToCore((TaskFunction_t   )task1,         /* 任务函数 */
     ...
     /* 创建任务2 */
     Task2Task_Handler = xTaskCreateStaticPinnedToCore((TaskFunction_t   )task2,         /* 任务函数 */
                                                       ...
                                                       (BaseType_t       ) 0);           /* 该任务哪个内核运行 */
     /* 创建任务3 */
     Task3Task_Handler = xTaskCreateStaticPinnedToCore((TaskFunction_t   )task3,         /* 任务函数 */
