 ...
 */
 ...
 void freertos_demo(void)
 {
     ...
     spilcd_show_string(10, 47, 220, 24, 24, "Mutex Semaphore", RED);
 ...
 void task1(void *pvParameters)
 {
     ...
     while (1)
     {
         ESP_LOGI("freertos_demo","task1 ready to take mutex");
         xSemaphoreTake(MutexSemaphore, portMAX_DELAY);  /* 获取互斥信号量 */
         ESP_LOGI("freertos_demo","task1 has taked mutex");
         ESP_LOGI("freertos_demo","task1 running");
         ESP_LOGI("freertos_demo","task1 give mutex");
 ...
 void task3(void *pvParameters)
 {
     ...
     while (1)
     {
         ESP_LOGI("freertos_demo","task3 ready to take mutex");
         xSemaphoreTake(MutexSemaphore, portMAX_DELAY);  /* 获取互斥信号量 */
         ESP_LOGI("freertos_demo","task3 has taked mutex");
         ...
         ESP_LOGI("freertos_demo","task3 give mutex");
         xSemaphoreGive(MutexSemaphore);                 /* 释放互斥信号量 */
         vTaskDelay(pdMS_TO_TICKS(1000));
     }
 }
