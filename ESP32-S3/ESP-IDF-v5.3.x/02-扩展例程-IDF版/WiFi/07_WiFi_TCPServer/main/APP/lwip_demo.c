 ...
 */
 ...
 void lwip_demo(void)
 {
     ...
     spilcd_show_string(5, 170, 200, 16, 16, tbuf, BLUE);
     ...
     while(1)
     {
         ...
         {
            spilcd_show_string(5, 190, 200, 16, 16, "State:Connection...", BLUE);
         ...
         while (1)
         {
             ...
             if (length <= 0)
             {
                 spilcd_show_string(5, 190, 200, 16, 16, "State:no Connection", BLUE);
                 break;
             }
